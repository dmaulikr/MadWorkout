...
//                self.theSynchButton.alpha = 0.0
    ...
    // ========================================================================= Actions des boutons
    // Enregistre dans le press-papier de l'appareil
...
//        })
    ...
    // Reinisiatlise les champs et les selection de la page
    @IBAction func doneButton(_ sender: UIButton) {
        ...
        self.theRepsField.text?.removeAll()
        self.theSetsField.text?.removeAll()
    }
    ...
    fileprivate func addExercise() {
        ...
        if self.exerciseAccountability[theExercise!] == nil // Ajout de ! 
        {
